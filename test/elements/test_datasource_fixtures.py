...
Shape = t.Dict[str, t.Union[bool, int, float, str, t.Dict[str, t.Union[bool, int, float, str]]]]
...
SUNANDMOON_DATASOURCE: t.Dict[str, t.Any] = {
    "id": 46,
    "uid": "239fasva4",
    "name": "SunAndMoon",
...
SUNANDMOON_DATASOURCE_INCOMPLETE: t.Dict[str, t.Any] = deepcopy(SUNANDMOON_DATASOURCE)
