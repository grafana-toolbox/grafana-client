...
class DashboardVersions(Base):
    ...
    @staticmethod
    def api_path(dashboard_id: Optional[int] = None, dashboard_uid: Optional[str] = None):
    ...
    def get_dashboard_version_by_id(self, dashboard_id: Optional[int] = None, version_id: Optional[int] = None):
        return self.get_dashboard_version(dashboard_id=dashboard_id, version_id=version_id)

    def get_dashboard_version_by_uid(self, dashboard_uid: Optional[str] = None, version_id: Optional[int] = None):
    ...
    def restore_dashboard_by_id(self, dashboard_id: Optional[int] = None, version_id: Optional[int] = None):
        return self.restore_dashboard(dashboard_id=dashboard_id, version_id=version_id)

    def restore_dashboard_by_uid(self, dashboard_uid: Optional[str] = None, version_id: Optional[int] = None):
