...
class AlertingProvisioning(Base):
    ...
    def get_contactpoints(self):
        ...
        r = self.client.GET(get_contactpoints_path)
        return r
    ...
    def create_contactpoint(self, contactpoint):
        ...
        r = self.client.POST(create_contactpoint_path, json=contactpoint)
    ...
    def update_contactpoint(self, contactpoint_uid, contactpoint):
        ...
        r = self.client.PUT(update_contactpoint_path, json=contactpoint)
    ...
    def delete_contactpoint(self, contactpoint_uid):
        ...
        r = self.client.DELETE(delete_contactpoint_path)
    ...
    def get_notification_policy_tree(self):
        ...
        r = self.client.GET(get_notification_policy_tree_path)
    ...
    def set_notification_policy_tree(self, notification_policy_tree):
        ...
        r = self.client.PUT(set_notification_policy_tree_path, json=notification_policy_tree)
    ...
    def get_mute_timings(self):
        ...
        r = self.client.GET(get_mute_timings_path)
    ...
    def get_mute_timing(self, mutetiming_name):
        ...
        r = self.client.GET(get_mute_timing_path)
    ...
    def create_mute_timing(self, mutetiming):
        ...
        r = self.client.POST(create_mute_timing_path, json=mutetiming)
    ...
    def update_mute_timing(self, mutetiming_name, mutetiming):
        ...
        r = self.client.PUT(update_mute_timing_path, json=mutetiming)
    ...
    def delete_mute_timing(self, mutetiming_name):
        ...
        r = self.client.GET(delete_mute_timing_path)
    ...
    def get_templates(self):
        ...
        r = self.client.GET(get_templates_path)
    ...
    def get_template(self, template_name):
        ...
        r = self.client.GET(get_template_path)
    ...
    def create_or_update_template(self, template_name, template):
        ...
        r = self.client.PUT(create_template_path, json=template)
    ...
    def delete_template(self, template_name):
        ...
        """
        create_template_path = "/v1/provisioning/templates/%s" % template_name
        r = self.client.DELETE(create_template_path)