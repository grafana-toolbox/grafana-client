...
class Teams(Base):
    ...
    async def get_team(self, team_id):
        ...
        r = await self.client.GET(get_team_path)
        return r
    ...
    async def add_team(self, team):
        ...
        """
        add_team_path = "/teams"
        r = await self.client.POST(add_team_path, json=team)
        return r
    ...
    async def update_team(self, team_id, team):
        ...
        r = await self.client.PUT(update_team_path, json=team)
        return r
    ...
    async def delete_team(self, team_id):
        ...
        r = await self.client.DELETE(delete_team_path)
        return r
    ...
    async def get_team_members(self, team_id):
        ...
        r = await self.client.GET(get_team_members_path)
        return r
    ...
    async def add_team_member(self, team_id, user_id):
        ...
        r = await self.client.POST(add_team_member_path, json=payload)
        return r
    ...
    async def remove_team_member(self, team_id, user_id):
        ...
        r = await self.client.DELETE(remove_team_member_path)
        return r
    ...
    async def get_preferences(self, team_id: int):
        ...
        r = await self.client.GET(get_team_preferences_path)
        return r
    ...
    async def update_preferences(self, team_id: int, preferences: PersonalPreferences):
        ...
        r = await self.client.PUT(update_team_preferences_path, json=data)
        return r
    ...
    async def get_team_external_group(self, team_id):
        ...
        r = await self.client.GET(team_group_path)
        return r
    ...
    async def add_team_external_group(self, team_id, group):
        ...
        """
        team_group_path = "/teams/%s/groups" % team_id
        r = await self.client.POST(team_group_path, json={"groupId": group})
        return r
    ...
    async def remove_team_external_group(self, team_id, group_id):
        ...
        r = await self.client.DELETE(team_group_path)
        return r
